            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                  @foreach ($data_saran as $ds)
                   <tr>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-3 py-2 ">
                      <div class="d-flex flex-column justify-content-center">
                      <div class="mb-0 text-xs font-weight-bold mb-0">
                      {{$loop->iteration}}
                      </div>
                      </div>
                      </div>  
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <div class="mb-0 text-xs font-weight-bold mb-0">{{$ds['user_id']}}</div>
                          </div>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0">{{$ds['type']}}</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0">{{$ds['message']}}</p>
                      </td>
